...
//        pageNumberView.backgroundColor = UIColor.yellow.withAlphaComponent(0.4)
    ...
    open override func layoutSubviews() {
        ...
        // 旋转 适配问题
//        let numberY = 0.0 - (self.pageNumberHeight + self.pageNumberSpace)
        let numberX = (containerView.bounds.width - self.pageNumberWidth) / 2.0
        var numberRect = pageNumberView.frame
        numberRect.origin.x = numberX
        pageNumberView.frame = numberRect
