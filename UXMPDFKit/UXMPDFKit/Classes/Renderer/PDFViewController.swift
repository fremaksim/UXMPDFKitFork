...
open class PDFViewController: UIViewController {
    ...
    open override func viewDidLayoutSubviews() {
        ...
        //旋转屏幕适配
        let index = collectionView.indexForPage(self.document.currentPage)
        collectionView.selectItem(at: IndexPath(row: index, section: 0), animated: false, scrollPosition: .left)
